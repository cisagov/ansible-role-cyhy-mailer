...
issue](https://github.com/cisagov/ansible-role-cyhy-mailer/issues) in
...
request](https://github.com/cisagov/ansible-role-cyhy-mailer/pulls),
...
```console
cd ansible-role-cyhy-mailer
pyenv virtualenv <python_version_to_use> ansible-role-cyhy-mailer
pyenv local ansible-role-cyhy-mailer
